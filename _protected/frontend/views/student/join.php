                    ...
                    <div class="col-lg-7 px-5">
                        <div class="col-lg-12">
                            ...
                            <div class="row flex-column justify-content-center mt-5">
                                <h4> Kursga yozilish uchun ma'lumot kiriting.</h4>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <?= $form->field($model, 'first')->label('Ism kiriting') ?>
                            </div>
                            <div class="form-group col-md-6">
                                <?= $form->field($model, 'last')->label('Familiya kiriting') ?>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <?= $form->field($model, 'course')->dropdownList($data, ['browser-default custom-select'])->label('Kurs tanlang') ?>
                            </div>
