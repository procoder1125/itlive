 ...
 */
class KurslarController extends BackendController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            if ($model->validate()) {
                $model->filename = $model->foto->name.'.'.$model->foto->extension;
                $model->foto->saveAs('../uploads/fotocourse/'.$model->filename);
                $model->save(false);
